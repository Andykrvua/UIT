...
var scroll = new smooth_scroll__WEBPACK_IMPORTED_MODULE_2___default.a(".smooth, nav a", {
  speed: 300
}); // form style
...
inputmask__WEBPACK_IMPORTED_MODULE_3___default()().mask(document.querySelector(".i_phone")); // send form
